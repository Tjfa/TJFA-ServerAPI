<?php
	class TeamBean
	{
		...
		{
			return urldecode (json_encode( array("teamId"=>$this->teamId,"emblemPath"=>urlencode($this->emblemPath),"groupGoalCount"=>$this->groupGoalCount,"groupMissCount"=>$this->groupMissCount,"goalCount"=>$this->goalCount,"missCount"=>$this->missCount, "groupWinCount"=>$this->groupWinCount,"groupMissCount"=>$this->groupMissCount,"groupDrawCount"=>$this->groupDrawCount,"winCount"=>$this->winCount,"missCount"=>$this->missCount,"groupNo"=>urlencode($this->groupNo),"name"=>urlencode($this->name),"score"=>$this->score,"competitionId"=>$this->competitionId,"rank"=>$this->rank ) ) );
		}
